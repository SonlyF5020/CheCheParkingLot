...
public class ParkingLotTest {
    ...
    public void should_not_get_car_by_wrong_number() throws Exception {
        MyCar myCart = new MyCar();
        parkingLot.acceptOneCar(myCart);
        MyCar myCar = parkingLot.pullOutCar(myCart.getToken() + "dsadasdad");
    ...
    public void should_not_park_a_car_when_lot_is_full() throws Exception {
        ...
        MyCar myCar = new MyCar();
        assertThat(parkingLot.acceptOneCar(myCar), is(false));
    }
}
